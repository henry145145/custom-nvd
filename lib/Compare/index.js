...
const metadata = new _chart.ChartMetadata({
  ...
  description: (0, _translation.t)('A line chart component where you can compare the % change over time'),
  name: (0, _translation.t)('Time-series Percent Change'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class CompareChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
